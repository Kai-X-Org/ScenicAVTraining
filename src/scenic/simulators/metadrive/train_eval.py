...
def scenic_env(scenic_file, stored_scene_data=None, seed=None):
...
if __name__ == "__main__":
    ...
    pprint(f"Training started at {now}, training finished at {datetime.datetime.now().strftime('%m_%d_%H_%M')}")
